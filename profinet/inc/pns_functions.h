...
//  uint8_t abActorData[PNS_PROCESS_DATA_INPUT_SIZE];   /* Control data produced by Master, to control device peripherals (e.g. LEDs) */
//  uint8_t abSensorData[PNS_PROCESS_DATA_OUTPUT_SIZE]; /* Status data for the Master, generated by the device peripherals (e.g. Temperature)*/
